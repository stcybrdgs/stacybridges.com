...
(function (factory) {
  ...
  $.fn.bigSlideLeft = function(options) {
    ...
    var view = {
      init: function(){
        ...
        menuLink.on('click.bigSlideLeft touchstart.bigSlideLeft', function(e) {
          e.preventDefault();
        ...
        if (settings.easyClose) {
          $(document).on('click.bigSlideLeft', function(e) {
      ...
      _destroy: function(){
        ...
        menuLink
          ...
          .off('click.bigSlideLeft touchstart.bigSlideLeft');
