...
(function (factory) {
  ...
  $.fn.bigSlideRight = function(options) {
    ...
    var view = {
      init: function(){
        ...
        menuLink.on('click.bigSlideRight touchstart.bigSlideRight', function(e) {
          e.preventDefault();
        ...
        if (settings.easyClose) {
          $(document).on('click.bigSlideRight', function(e) {
      ...
      _destroy: function(){
        ...
        menuLink
          ...
          .off('click.bigSlideRight touchstart.bigSlideRight');
